...
namespace zad2
{
    class Program
    {
        ...
        static List<Bohater> tworzPostacie()
        {
            ...
            postacie.Add(new Mag("Mag", 50, 20, RasaEnum.Rasy.Czlowiek, 100));
            postacie.Add(new Wojownik("Wojownik", 250, 100, RasaEnum.Rasy.Krasnolud));

            postacie.Add(new Rzezimieszek("Przeciwnik", 400, 80, RasaEnum.Rasy.Ork, 50));
